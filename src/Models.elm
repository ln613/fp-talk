...
initialModel =
  { pages = 
    [ Page "JavaScript and the Rise of Functional Programming" "" [],
      ...
      Page "Functional Reactive Programming" "" [ "Reactive Programming", "&a -> b, a$ -> b$, Observable", "Observable vs Promise", "&cancel, retry, debounce...", "Functional Reactive Programming", "&Array in the future, lazy", "ReactiveX operators", "&map, filter, reduce (scan)..." ],
      ...
      Page "Cycle - Demo" "&y0ECbbs8BZVKgrOC84Cz" [],
